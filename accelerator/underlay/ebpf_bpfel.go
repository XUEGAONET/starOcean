...
type ebpfProgramSpecs struct {
	XskUnderlay *ebpf.ProgramSpec `ebpf:"xsk_underlay"`
}
...
type ebpfMapSpecs struct {
	RedirectIpv6 *ebpf.MapSpec `ebpf:"redirect_ipv6"`
	RedirectPort *ebpf.MapSpec `ebpf:"redirect_port"`
...
type ebpfMaps struct {
	RedirectIpv6 *ebpf.Map `ebpf:"redirect_ipv6"`
	RedirectPort *ebpf.Map `ebpf:"redirect_port"`
...
type ebpfPrograms struct {
	XskUnderlay *ebpf.Program `ebpf:"xsk_underlay"`
}
